...
import { SocketConnectionInterface } from "src/@modules/shared/connections/connectionSocket.interface";

export class SocketConnection implements SocketConnectionInterface {
